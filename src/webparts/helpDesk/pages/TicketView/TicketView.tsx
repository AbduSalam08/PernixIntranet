...
const TicketView = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    getAttachmentofTicket(currentTicketsData?.ID);
  }, []);
        ...
        <div className={styles.ticketHeader}>
          <div className={styles.ticketHeaderMain}>
            ...
            <div className={styles.ticketOneLine}>
              {currentTicketsData?.EmployeeName?.Title} raised this ticket on{" "}
              ...
              {currentTicketsData?.TicketClosedOn !== null &&
                `closed on ${dayjs(currentTicketsData?.TicketClosedOn)?.format(
                  "DD MMM YYYY"
                )}`}
            </div>
          </div>
        ...
        <div className={styles.detailsCard}>
          ...
          <div className={styles.details}>
            ...
            <div className={styles.detailsLabel}>
              ...
              <span>
                {dayjs(currentTicketsData?.Modified).format("DD MMM YYYY") ??
                  "-"}
              </span>
            </div>
            ...
            <div className={styles.detailsLabel}>
              ...
              <span>{currentTicketsData?.RepeatedTicket ? "Yes" : "No"}</span>
            </div>
                ...
                {currentTicketsData?.TicketManagerId !== null ? (
                  <>
                    ...
                    <div className={styles.userDetails}>
                      ...
                      <span>{currentTicketsData?.TicketManager?.EMail}</span>
                    </div>
                  </>
                ) : (
                  <StatusPill size="SM" status="Unassigned" />
