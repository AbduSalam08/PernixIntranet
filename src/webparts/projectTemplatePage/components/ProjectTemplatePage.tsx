...
//   const [selectedProject, setSelectedProject] = useState<ProjectDetails | any>(
//     null
//   );
...
//     if (!hasErrors) {
//       let addid = await handleAddNewProject(formData);
...
//         projectAdmin: {
//           id: formData.projectAdmin.value?.id,
//           name: formData.projectAdmin.value?.name,
//           email: formData.projectAdmin.value?.email,
//         },
//         clientName: formData.clientName.value,
//         location: formData.location.value,
//         address: formData.address.value,
//         team: formData.team.value.map((team: any) => ({
//           id: team?.id,
//           name: team?.name,
//           email: team?.email,
//         })),
//         startDate: formData.StartDate.value
//           ? moment(formData.StartDate.value).format("YYYY-MM-DD")
//           : null,
//         endDate: formData.EndDate.value
//           ? moment(formData.EndDate.value).format("YYYY-MM-DD")
//           : null,
//         description: formData.Description.value,
//       };
//       debugger;

//       setProjectData((prevData: any[]) => [...prevData, newObject]);
...
//     await dispatch(setMainSPContext(props?.context));
//     let details: ProjectDetails[] = await getProjectDetails();
