...
import * as strings from "ApprovalsPageWebPartStrings";
import ApprovalsPage from "./components/ApprovalsPage";
// import { IApprovalsPageProps } from './components/IApprovalsPageProps';
...
export interface IApprovalsPageWebPartProps {
  description: string;
}

export default class ApprovalsPageWebPart extends BaseClientSideWebPart<IApprovalsPageWebPartProps> {
