...
import * as strings from "NewsPageWebPartStrings";
...
// import { INewsPageProps } from './components/INewsPageProps';

export interface INewsPageWebPartProps {
  description: string;
}

export default class NewsPageWebPart extends BaseClientSideWebPart<INewsPageWebPartProps> {
  ...
  // public render(): void {
  //   const element: React.ReactElement<INewsPageProps> = React.createElement(
  //     NewsPage,
  //     {
