...
export default class BirthdayIntranet extends React.Component<IBirthdayIntranetProps, {}> {
  public render(): React.ReactElement<IBirthdayIntranetProps> {
    ...
    return (
      <section className={`${styles.birthdayIntranet} ${hasTeamsContext ? styles.teams : ''}`}>
