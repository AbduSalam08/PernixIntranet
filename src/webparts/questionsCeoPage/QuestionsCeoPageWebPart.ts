...
import * as strings from "QuestionsCeoPageWebPartStrings";
import QuestionsCeoPage from "./components/QuestionsCeoPage";
// import { IQuestionsCeoPageProps } from './components/IQuestionsCeoPageProps';
...
export interface IQuestionsCeoPageWebPartProps {
  description: string;
}

export default class QuestionsCeoPageWebPart extends BaseClientSideWebPart<IQuestionsCeoPageWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement = React.createElement(
      ...
      React.createElement(QuestionsCeoPage, {
