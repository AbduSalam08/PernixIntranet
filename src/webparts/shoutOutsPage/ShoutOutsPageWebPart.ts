...
import * as strings from "ShoutOutsPageWebPartStrings";
import ShoutOutsPage from "./components/ShoutOutsPage";
// import { IShoutOutsPageProps } from "./components/IShoutOutsPageProps";
...
export interface IShoutOutsPageWebPartProps {
  description: string;
}

export default class ShoutOutsPageWebPart extends BaseClientSideWebPart<IShoutOutsPageWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement = React.createElement(
      ...
      React.createElement(ShoutOutsPage, {
