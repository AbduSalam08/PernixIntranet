...
import * as strings from "PtoPageWebPartStrings";
import PtoPage from "./components/PtoPage";
// import { IPtoPageProps } from './components/IPtoPageProps';

export interface IPtoPageWebPartProps {
  description: string;
}

export default class PtoPageWebPart extends BaseClientSideWebPart<IPtoPageWebPartProps> {
