...
export default class NewHiresIntranet extends React.Component<INewHiresIntranetProps, {}> {
  public render(): React.ReactElement<INewHiresIntranetProps> {
    ...
    return (
      <section className={`${styles.newHiresIntranet} ${hasTeamsContext ? styles.teams : ''}`}>
