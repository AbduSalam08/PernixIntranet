...
import * as strings from "DocumentRepositoryPageWebPartStrings";
import DocumentRepositoryPage from "./components/DocumentRepositoryPage";
// import { IDocumentRepositoryPageProps } from './components/IDocumentRepositoryPageProps';
...
export interface IDocumentRepositoryPageWebPartProps {
  description: string;
}

export default class DocumentRepositoryPageWebPart extends BaseClientSideWebPart<IDocumentRepositoryPageWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement = React.createElement(
      ...
      React.createElement(DocumentRepositoryPage, {
