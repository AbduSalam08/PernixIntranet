...
import * as strings from "EmployeeDirectoryPageWebPartStrings";
import EmployeeDirectoryPage from "./components/EmployeeDirectoryPage";
// import { IEmployeeDirectoryPageProps } from './components/IEmployeeDirectoryPageProps';
...
export interface IEmployeeDirectoryPageWebPartProps {
  description: string;
}

export default class EmployeeDirectoryPageWebPart extends BaseClientSideWebPart<IEmployeeDirectoryPageWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement = React.createElement(
      ...
      React.createElement(EmployeeDirectoryPage, {
