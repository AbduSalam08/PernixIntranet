...
import * as strings from "OrgChartPageWebPartStrings";
import OrgChartPage from "./components/OrgChartPage";
// import { IOrgChartPageProps } from './components/IOrgChartPageProps';
...
export interface IOrgChartPageWebPartProps {
  description: string;
}

export default class OrgChartPageWebPart extends BaseClientSideWebPart<IOrgChartPageWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement = React.createElement(
      ...
      React.createElement(OrgChartPage, {
