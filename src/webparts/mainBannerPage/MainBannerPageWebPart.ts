...
import * as strings from "MainBannerPageWebPartStrings";
import MainBannerPage from "./components/MainBannerPage";
// import { IMainBannerPageProps } from "./components/IMainBannerPageProps";
...
export interface IMainBannerPageWebPartProps {
  description: string;
}

export default class MainBannerPageWebPart extends BaseClientSideWebPart<IMainBannerPageWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement = React.createElement(
      ...
      React.createElement(MainBannerPage, {
