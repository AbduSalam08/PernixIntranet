...
export default class ShoutOutsIntranet extends React.Component<IShoutOutsIntranetProps, {}> {
  public render(): React.ReactElement<IShoutOutsIntranetProps> {
    ...
    return (
      <section className={`${styles.shoutOutsIntranet} ${hasTeamsContext ? styles.teams : ''}`}>
