...
import * as strings from "ShoutOutsIntranetWebPartStrings";
import ShoutOutsIntranet from "./components/ShoutOutsIntranet";
// import { IShoutOutsIntranetProps } from "./components/IShoutOutsIntranetProps";
...
export default class ShoutOutsIntranetWebPart extends BaseClientSideWebPart<IShoutOutsIntranetWebParProps> {
  ...
  public render(): void {
    const element: React.ReactElement = React.createElement(
      ...
      React.createElement(ShoutOutsIntranet, {
  ...
  // public render(): void {
  //   const element: React.ReactElement<IShoutOutsIntranetProps> =
  //     React.createElement(ShoutOutsIntranet, {
