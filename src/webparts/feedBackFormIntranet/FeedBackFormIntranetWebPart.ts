...
import { IFeedBackFormIntranetProps } from './components/IFeedBackFormIntranetProps';
...
export default class FeedBackFormIntranetWebPart extends BaseClientSideWebPart<IFeedBackFormIntranetWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IFeedBackFormIntranetProps> = React.createElement(
      FeedBackFormIntranet,
      {
