...
export default class CalendarIntranet extends React.Component<ICalendarIntranetProps, {}> {
  public render(): React.ReactElement<ICalendarIntranetProps> {
    ...
    return (
      <section className={`${styles.calendarIntranet} ${hasTeamsContext ? styles.teams : ''}`}>
